...
var map = new ol.Map({
    ...
    view: new ol.View({
        maxZoom: 28,
        minZoom: 1,
        extent: [409425.411081, 4642399.098537, 459637.722461, 4675753.447937],
        projection: new ol.proj.Projection({
            code: 'EPSG:6708',
            //extent: [423507.743537, 4648918.745756, 448897.296760, 4670343.748921],
            units: 'm'
        })
    })
});
...
map.getView().fit([419425.411081, 4652399.098537, 449637.722461, 4665753.447937], map.getSize());
...
//move controls inside containers, in order
    ...
    //popup coordinates (mostra coordinate) — inserito sopra lo strumento misura
    var popupCoordinatesControl = document.getElementsByClassName('popup-coordinates')[0];
    if (popupCoordinatesControl) {
        popupCoordinatesControl.style.marginBottom = '4px';
        topLeftContainerDiv.appendChild(popupCoordinatesControl);
    }
    //measure
