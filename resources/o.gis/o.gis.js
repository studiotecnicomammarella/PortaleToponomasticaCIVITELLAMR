...
// popup Coordinates position control
	...
	// subito dopo di esso nel DOM. Il layout CSS gestirà il posizionamento a destra.
	setTimeout(function() {
		...
		if (_pcCtrl && _wmsCtrl && _wmsCtrl.parentNode) {
			// Inserisce il pulsante coordinate subito DOPO il pulsante WMS
			_wmsCtrl.parentNode.insertBefore(_pcCtrl, _wmsCtrl.nextSibling);
			// Posizionamento assoluto alla destra di WMS alla stessa altezza
			function positionPc() {
	...
	// Traduzione tooltip controlli nativi OpenLayers
	document.addEventListener('DOMContentLoaded', function() {
		setTimeout(function() {
			...
			// Traduzione strumenti editBar (toolbar Disegna) — SOLO tooltip/title
			// NON tocca i pulsanti undo/finish che appaiono durante il disegno
	...
	// Traduzione tooltip controlli nativi OpenLayers (applicata dopo caricamento DOM)
	document.addEventListener('DOMContentLoaded', function() {
		setTimeout(function() {
			// Zoom in / Zoom out
			var zoomIn = document.querySelector('.ol-zoom-in');
			...
			var rotateReset = document.querySelector('.ol-rotate button');
			if (rotateReset) rotateReset.title = 'Azzera rotazione';
			// Zoom to extent (ol-ext layerswitcher)
			document.querySelectorAll('.layerExtent button, .ol-zoom-extent button').forEach(function(btn) {
				btn.title = 'Zoom sull\'estensione';
			});
			// Layer up / layer down (ol-ext reordering)
			document.querySelectorAll('.layerup button').forEach(function(btn) {
				btn.title = 'Sposta layer su/giù';
			});
			// FullScreen
			var fsBtn = document.querySelector('.ol-full-screen button');
			if (fsBtn) fsBtn.title = 'Schermo intero';
