...
//ol.proj.get("EPSG:6708").setExtent([419425.411081, 4652399.098537, 449637.722461, 4665753.447937]);
var wms_layers = [];
...
maxResolution:5.600893230452393,
    ...
    creationdate: '2026-04-21 12:11:07',
    interactive: true,
    style: style_Acque,
...
lyr_OpenStreetMap.setVisible(false);lyr_GoogleRoad.setVisible(false);lyr_GoogleSatellite.setVisible(false);lyr_GoogleHybrid.setVisible(true);lyr_Acque.setVisible(true);lyr_Strade.setVisible(true);lyr_Particelle.setVisible(true);lyr_Fabbricati.setVisible(true);lyr_NumeriParticelle.setVisible(true);lyr_CIVICI.setVisible(true);lyr_SEZIONIDICENSIMENTOISTAT.setVisible(true);lyr_FogliCatastali.setVisible(true);lyr_CONFINECOMUNALE.setVisible(true);lyr_CONFINIISTAT.setVisible(true);
var layersList = [lyr_OpenStreetMap,lyr_GoogleRoad,lyr_GoogleSatellite,lyr_GoogleHybrid,group_CATASTALE,group_TOPONOMASTICA,lyr_FogliCatastali,lyr_CONFINECOMUNALE,lyr_CONFINIISTAT];
...
lyr_SEZIONIDICENSIMENTOISTAT.set('fieldImages', {'fid': 'TextEdit', 'COD_REG': 'TextEdit', 'COD_UTS': 'TextEdit', 'PRO_COM': 'TextEdit', 'SEZIONE DI CENSIMENTO': 'Range', 'SEZ21_ID': 'TextEdit', 'COD_TIPO_S': 'TextEdit', 'TIPO_LOC': 'TextEdit', 'LOC21_ID': 'TextEdit', 'COD_ZIC': 'TextEdit', 'COD_ISAM': 'TextEdit', 'COD_ACQUE': 'TextEdit', 'COD_ISOLE': 'TextEdit', 'COD_MONT_D': 'TextEdit', 'COD_AREA_S': 'TextEdit', 'COM_ASC1': 'TextEdit', 'COM_ASC2': 'TextEdit', 'COM_ASC3': 'TextEdit', 'POP21': 'TextEdit', 'FAM21': 'TextEdit', 'ABI21': 'TextEdit', 'EDI21': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
